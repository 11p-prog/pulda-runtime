...
| CR-0013 | Restore the First Living Loop | High | In Progress — AI/LLM interpretation now connected (Anthropic Claude, Runtime-verified 2026-08-20); correction UI, PDF-derived loop, connector-outage resilience, and user verification still open | ChatGPT/Claude Code | User | 2026-07-13 | 2026-08-20 |
...
| CR-0015 | ChatGPT Daily Activity Capture | High | In Progress — 2026-07-22 receipt-atomicity repair committed and deployed (`064930e`, `5e43003`); whether the repair script's `--apply` step and the follow-up Notion pull were actually run against Runtime data is unconfirmed by the user; Notion relay reauthorization/end-to-end run still pending | ChatGPT | User | 2026-07-18 | 2026-08-27 |
